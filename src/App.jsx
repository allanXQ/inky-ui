        ...
        <div id="meetinky" className="flex items-center justify-center gap-4">
          ...
          <div className="flex flex-col gap-4 max-w-80">
            ...
            <p>
              ...
              owners and people all over have benefited from the raw energy of
              his thought provoking and inspirational presentations. Whether the
              topic is leadership, teamwork, excelling in the midst of
              adversity, embracing change, mental agility or perseverance,
              Inky’s message is effective and efficient.
            </p>
        ...
        >
          ...
          <div className="flex flex-col gap-2 items-center w-[600px] border border-white rounded-lg p-10 ">
            <p>
              ...
              my hand are paralyzed but my heart isn’t, my mind isn’t, my
              dedication isn’t, my work ethic isn’t, my commitment isn’t.”
            </p>
            <p>-INKY</p>
          </div>
        </div>
